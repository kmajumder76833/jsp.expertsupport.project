...
<table class="table-of-contents yellow">
        <tr class="gridheader">
            <td>LID</td>
            <td>NAME</td>
            <td>LASTLOGIN</td>
            ...
            <center>
            <a href="updateuserinfo.jsp"><button style="margin-top: 20px;" class="btn waves-effect waves-light " type="submit" name="clear">UPDATE YOUR DETAIL
    </button></a>
