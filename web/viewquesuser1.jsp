...
<div>
    ...
    <div style="margin-left: 80px;margin-top: 30px;margin-bottom: 200px;">
        
        <a href="viewques"><button style="margin-top: 50px;" class="btn waves-effect waves-light large" type="submit" name="action">VIEW ALL QUESTIONS
    </button></a>
<a href="quesuser"><button  style="margin-top: 50px;margin-left: 250px;" class="btn waves-effect waves-light large" type="submit" name="action">VIEW YOUR QUESTIONS
    </button></a>    
