 ...
 * @author USER-1
 */
public class QuesForEachUser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String query="from Questions q where q.uidfk= '"+request.getSession().getAttribute("lId")+"'";
        Query q=s.createQuery(query);
        List<Questions> data=q.list();
        request.setAttribute("quesdata", data);
        RequestDispatcher rd=request.getRequestDispatcher("viewquesuser2.jsp");
